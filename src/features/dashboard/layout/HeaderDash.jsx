...
export const HeaderDash = ({ userData, toggleMenu, menuOpen, handleLogout }) => {
  ...
  return (
    <header className="fixed w-full top-0 left-0 z-50 bg-principal backdrop-blur-lg">
      <div className="flex justify-between items-center px-4 sm:px-6 lg:px-8 h-16 border-b-2 border-linea">
        <div className="flex items-center gap-2">
          <img src={logo} alt="Logo" className="w-[70px] rounded-full" />
          <h1 className="text-xl font-bold text-white hover:text-[#A975FF] transition-colors duration-300">
            INSTANT3D
          </h1>
        </div>
        ...
        {userData && (
          <div className="flex items-center gap-3">
            <div className="relative hidden sm:block" ref={dropdownRef}>
              ...
              <div
                className={`
                  absolute right-0 mt-2 w-56 rounded-xl bg-principal border-2 border-linea shadow-lg
              ...
              >
                ...
                <div className="py-1">
                  <Link
                    to="configdash"
                    className="flex items-center px-4 py-3 text-sm text-white hover:bg-bg-btn-dash transition-all duration-200 group/item"
