...
export const Imagen3DInput = ({ isCollapsed }) => {
  ...
  const handleRegenerateClick = () => {
    if (isResultReady && prediction_img3d_result) {
  ...
  const handleConfirmRegenerate = async () => {
    ...
    if (!user || !prediction_img3d_result || !imageFile) return;
  ...
  return (
    <>
              ...
              <div className="bg-gray-50 dark:bg-principal/30 backdrop-blur-sm border border-gray-200 dark:border-linea/20 rounded-2xl p-4 h-full flex flex-col space-y-4">
                ...
                <div className="flex-grow flex flex-col min-h-0">
                  ...
                  <div
                    ...
                    onClick={() => !isFormDisabled && document.getElementById("fileInput-imagen3d").click()}
                  >
                    <input
      ...
      <RegenerateConfirmationModal
        ...
        generationName={prediction_img3d_result?.generation_name || ""}
      />
    </>
  );
};