...
export const Boceto3DInput = ({
  ...
  const resetComponentState = useCallback(() => {
    ...
    clearCanvas();
  }, [clearPredictionError, setPrediction_boceto3d_result, clearCanvas]);
  ...
  const ToolButton = useCallback(
    ({ tool: buttonTool, icon: Icon, title }) => (
      <button
        onClick={() =>
          setDrawingState((prev) => ({ ...prev, tool: buttonTool }))
        }
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                disabled={predictionLoading}
                className="bg-transparent border border-linea p-2 rounded-md w-full text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
              />
            </div>
