...
export const TextImg3DInput = ({ isCollapsed }) => {
  ...
  const isMainButtonDisabled =
    isAnyProcessRunning ||
    (currentStep === 1 && (!generationName.trim() || !subject.trim())) ||
    (currentStep === 2 && !generatedImageUrl);
  const showProgressModal =
    isAnyProcessRunning && jobStatus?.status !== "completed";
            ...
            <div className="bg-gray-50 dark:bg-principal/30 backdrop-blur-sm border border-gray-200 dark:border-linea/20 rounded-2xl p-3 h-full flex flex-col space-y-2">
              ...
              <div className="mt-auto flex-shrink-0">
                ...
                >
                  ...
                  {currentStep === 1
                    ? t(
                        "generation_pages.text_image_to_3d_steps.generate_2d_button"
                      )
                    : t(
                        "generation_pages.text_image_to_3d_steps.generate_3d_button"
                      )}
                </button>
              </div>
            </div>
                  ...
                  {!isAnyProcessRunning && (
                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10">
                      ...
                      >
                        ...
                        {t(
                          "generation_pages.text_image_to_3d_steps.regenerate_2d_button"
                        )}
                      </button>
                    </div>
                  )}
