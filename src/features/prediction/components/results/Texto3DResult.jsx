import React, { Suspense, useState } from "react"; // Quita useEffect si no se usa
...
import {
  ...
  ArrowsClockwise,
  Aperture,
} from "@phosphor-icons/react"; // Verifica iconos
import { HDREnvironment } from "../shared/HDREnvironment"; // Verifica ruta
import { ModelViewer } from "../shared/ModelViewer"; // Verifica ruta y nombre
import { usePredictions } from "../../context/PredictionContext"; // Importa hook contexto
