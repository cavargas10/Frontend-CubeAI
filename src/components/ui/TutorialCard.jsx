...
export const TutorialCard = ({ tutorial }) => {
  ...
  return (
    <div className="group flex flex-col h-full bg-principal rounded-xl overflow-hidden 
                   border-2 border-linea/50 
                   transition-all duration-300 ease-out
                   hover:border-morado-gradient 
                   hover:shadow-[0_0_15px_theme('colors.morado-gradient'/20%)] 
