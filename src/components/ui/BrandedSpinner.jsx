    ...
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      >
        ...
        <div className="relative w-full h-full p-2 animate-pulse [animation-duration:2.5s]">
          <div className="w-full h-full rounded-full bg-principal/50 backdrop-blur-sm flex items-center justify-center">
            <img
              src={logo}
              alt="Loading..."
              className={`${selectedSize.logo} drop-shadow-[0_0_15px_rgba(169,117,255,0.5)]`}
            />
          </div>
        </div>
      </div>
